...
class ExportResultUI extends StatelessWidget {
          ...
          Center(
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  Text(title, style: AppTextStyle.heading20),
                  const SizedBox(height: 16),
                  Row(
                    children: [
                      Text("Inputs ", style: AppTextStyle.pw400),
                    ],
                  ),
                  ...
                  Row(
                    children: [
                      Text("Outputs ", style: AppTextStyle.pw400),
                    ],
                  ),
                  const SizedBox(height: 10),
  ...
  Widget _buildTable(Map<String, String> data) {
    return Table(
      border: TableBorder.all(color: AppColor.secondary),
      ...
      child: PieChart(
        PieChartData(
          ...
          sections: chartData.entries.map((entry) {
            final color = entry.key.toLowerCase().contains("interest")
                ? AppColor.primary
                : AppColor.secondary;
